...
public class ICustomerServiceTest {
	...
	public void addCustomer() throws InvalidDataException {
		CustomerDTO customer = new CustomerDTO(3, "sharath", "shask");
		List<Customer> customers = new ArrayList<>();
		Customer newCustomer = new Customer(3, "sharath", "shask");
	...
	public void addDuplicateCustomer() throws InvalidDataException {
		CustomerDTO customer = new CustomerDTO(3, "sharath", "shask");
		Customer dupCustomer = new Customer(3, "sharath", "shask");
		...
		Mockito.when(iCustomerRepository.findByCustomerPassword(customer.getCustomerPassword()))
				.thenReturn(dupCustomers);
	...
	public void viewCustomerWithId() throws InvalidDataException {
		CustomerDTO customer = new CustomerDTO(3, "sharath", "shask");
		Optional<Customer> newCustomer = Optional.of(new Customer(3, "sharath", "shask"));
		// List<Customer> customers = new ArrayList<>();
		...
		Assertions.assertEquals(customer.getCustomerId(),
				iCustomerService.viewCustomer(customer.getCustomerId()).getCustomerId());
	...
	public void updateCustomer() throws InvalidDataException {
		CustomerDTO customer = new CustomerDTO(3, "sharath", "shask");
		CustomerDTO customer1 = new CustomerDTO(3, "sharath", "shask");
		Optional<Customer> dupCustomer = Optional.of(new Customer(3, "sharath", "shask"));
	...
	public void deleteCustomerNotPresent() {
		InvalidDataException e = Assertions.assertThrows(InvalidDataException.class,
				() -> iCustomerService.deleteCustomer(2));
		Assertions.assertEquals("Service.CUSTOMER_NOT_FOUND", e.getMessage());
	}
