...
public class IMedicineServiceTest {
    ...
    public void addMedicine() throws InvalidDataException{
        ...
        Medicine newMedicine = new Medicine(1, "paracitamol", 500f, LocalDate.now(), LocalDate.now(), "AB", category);
    ...
    public void addDuplicateMedicine() throws InvalidDataException{
        ...
        Medicine newMedicine = new Medicine(1, "paracitamol", 500f, LocalDate.now(), LocalDate.now(), "AB", dupCategory);
